...
def biLSTM(input_dim=31819, output_dim=20, input_length=70, units=50, tag_size=18):
    model = Sequential()
...
def main():
    ...
    model = biLSTM(input_dim=vocab_size, output_dim=20, input_length=max_len, units=50, tag_size=tag_size)
